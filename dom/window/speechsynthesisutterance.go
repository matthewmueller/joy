...
func (*SpeechSynthesisUtterance) SetOnboundary(onboundary func(Event)) {
	js.Rewrite("$_.onboundary = $1", onboundary)
}
...
func (*SpeechSynthesisUtterance) SetOnresume(onresume func(Event)) {
	js.Rewrite("$_.onresume = $1", onresume)
}
