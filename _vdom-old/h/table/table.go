...
func New(props *Props, children ...vdom.Child) *Table {
	macro.Rewrite("$1('table', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Cellpadding(cellpadding string) *Props {
	macro.Rewrite("$1().Set('cellpadding', $2)", js.Runtime("Map", "Set", "JSON"), cellpadding)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Cellpadding(cellpadding string) *Props {
	macro.Rewrite("$_.Set('cellpadding', $1)", cellpadding)
...
func Cellspacing(cellspacing string) *Props {
	macro.Rewrite("$1().Set('cellspacing', $2)", js.Runtime("Map", "Set", "JSON"), cellspacing)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Cellspacing(cellspacing string) *Props {
	macro.Rewrite("$_.Set('cellspacing', $1)", cellspacing)
...
func Frame(frame string) *Props {
	macro.Rewrite("$1().Set('frame', $2)", js.Runtime("Map", "Set", "JSON"), frame)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Frame(frame string) *Props {
	macro.Rewrite("$_.Set('frame', $1)", frame)
	p.attrs["frame"] = frame
	return p
}
...
func Rules(rules string) *Props {
	macro.Rewrite("$1().Set('rules', $2)", js.Runtime("Map", "Set", "JSON"), rules)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Rules(rules string) *Props {
	macro.Rewrite("$_.Set('rules', $1)", rules)
	p.attrs["rules"] = rules
	return p
}
...
func Summary(summary string) *Props {
	macro.Rewrite("$1().Set('summary', $2)", js.Runtime("Map", "Set", "JSON"), summary)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Summary(summary string) *Props {
	macro.Rewrite("$_.Set('summary', $1)", summary)
