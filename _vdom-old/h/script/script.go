...
func New(props *Props, children ...vdom.Child) *Script {
	macro.Rewrite("$1('script', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Async(async string) *Props {
	macro.Rewrite("$1().Set('async', $2)", js.Runtime("Map", "Set", "JSON"), async)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Async(async string) *Props {
	macro.Rewrite("$_.Set('async', $1)", async)
	p.attrs["async"] = async
	return p
}
...
func Defer(dfr string) *Props {
	macro.Rewrite("$1().Set('dfr', $2)", js.Runtime("Map", "Set", "JSON"), dfr)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Defer(dfr)
}
...
func Language(language string) *Props {
	macro.Rewrite("$1().Set('language', $2)", js.Runtime("Map", "Set", "JSON"), language)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Language(language string) *Props {
	macro.Rewrite("$_.Set('language', $1)", language)
...
func Nonce(nonce string) *Props {
	macro.Rewrite("$1().Set('nonce', $2)", js.Runtime("Map", "Set", "JSON"), nonce)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Nonce(nonce string) *Props {
	macro.Rewrite("$_.Set('nonce', $1)", nonce)
	p.attrs["nonce"] = nonce
	return p
}
