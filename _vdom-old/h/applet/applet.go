...
func New(props *Props, children ...vdom.Child) *Applet {
	macro.Rewrite("$1('applet', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Code(code string) *Props {
	macro.Rewrite("$1().Set('code', $2)", js.Runtime("Map", "Set", "JSON"), code)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Code(code)
}
...
func (p *Props) Code(code string) *Props {
	macro.Rewrite("$_.Set('code', $1)", code)
	p.attrs["code"] = code
	return p
}
...
func Object(object string) *Props {
	macro.Rewrite("$1().Set('object', $2)", js.Runtime("Map", "Set", "JSON"), object)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Object(object string) *Props {
	macro.Rewrite("$_.Set('object', $1)", object)
