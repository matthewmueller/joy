...
func New(props *Props, children ...vdom.Child) *Ol {
	macro.Rewrite("$1('ol', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Compact(compact string) *Props {
	macro.Rewrite("$1().Set('compact', $2)", js.Runtime("Map", "Set", "JSON"), compact)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Compact(compact string) *Props {
	macro.Rewrite("$_.Set('compact', $1)", compact)
...
func Reversed(reversed string) *Props {
	macro.Rewrite("$1().Set('reversed', $2)", js.Runtime("Map", "Set", "JSON"), reversed)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Reversed(reversed string) *Props {
	macro.Rewrite("$_.Set('reversed', $1)", reversed)
...
func Start(start string) *Props {
	macro.Rewrite("$1().Set('start', $2)", js.Runtime("Map", "Set", "JSON"), start)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Start(start string) *Props {
	macro.Rewrite("$_.Set('start', $1)", start)
	p.attrs["start"] = start
	return p
}
