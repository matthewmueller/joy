...
func New(props *Props, children ...vdom.Child) *Form {
	macro.Rewrite("$1('form', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func AcceptCharset(acceptcharset string) *Props {
	macro.Rewrite("$1().Set('acceptcharset', $2)", js.Runtime("Map", "Set", "JSON"), acceptcharset)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) AcceptCharset(acceptcharset string) *Props {
	macro.Rewrite("$_.Set('acceptcharset', $1)", acceptcharset)
...
func Action(action string) *Props {
	macro.Rewrite("$1().Set('action', $2)", js.Runtime("Map", "Set", "JSON"), action)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Action(action string) *Props {
	macro.Rewrite("$_.Set('action', $1)", action)
...
func Enctype(enctype string) *Props {
	macro.Rewrite("$1().Set('enctype', $2)", js.Runtime("Map", "Set", "JSON"), enctype)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Enctype(enctype string) *Props {
	macro.Rewrite("$_.Set('enctype', $1)", enctype)
...
func Method(method string) *Props {
	macro.Rewrite("$1().Set('method', $2)", js.Runtime("Map", "Set", "JSON"), method)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Method(method string) *Props {
	macro.Rewrite("$_.Set('method', $1)", method)
...
func Novalidate(novalidate string) *Props {
	macro.Rewrite("$1().Set('novalidate', $2)", js.Runtime("Map", "Set", "JSON"), novalidate)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Novalidate(novalidate string) *Props {
	macro.Rewrite("$_.Set('novalidate', $1)", novalidate)
