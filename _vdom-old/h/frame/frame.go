...
func New(props *Props, children ...vdom.Child) *Frame {
	macro.Rewrite("$1('frame', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Noresize(noresize string) *Props {
	macro.Rewrite("$1().Set('noresize', $2)", js.Runtime("Map", "Set", "JSON"), noresize)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Noresize(noresize string) *Props {
	macro.Rewrite("$_.Set('noresize', $1)", noresize)
