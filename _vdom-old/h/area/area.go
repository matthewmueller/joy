...
func New(props *Props, children ...vdom.Child) *Area {
	macro.Rewrite("$1('area', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Nohref(nohref string) *Props {
	macro.Rewrite("$1().Set('nohref', $2)", js.Runtime("Map", "Set", "JSON"), nohref)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Nohref(nohref string) *Props {
	macro.Rewrite("$_.Set('nohref', $1)", nohref)
