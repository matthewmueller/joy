...
func New(props *Props, children ...vdom.Child) *Keygen {
	macro.Rewrite("$1('keygen', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Challenge(challenge string) *Props {
	macro.Rewrite("$1().Set('challenge', $2)", js.Runtime("Map", "Set", "JSON"), challenge)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Challenge(challenge string) *Props {
	macro.Rewrite("$_.Set('challenge', $1)", challenge)
...
func Keytype(keytype string) *Props {
	macro.Rewrite("$1().Set('keytype', $2)", js.Runtime("Map", "Set", "JSON"), keytype)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Keytype(keytype string) *Props {
	macro.Rewrite("$_.Set('keytype', $1)", keytype)
