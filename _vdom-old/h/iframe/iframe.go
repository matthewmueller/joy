...
func New(props *Props, children ...vdom.Child) *Iframe {
	macro.Rewrite("$1('iframe', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Allowfullscreen(allowfullscreen string) *Props {
	macro.Rewrite("$1().Set('allowfullscreen', $2)", js.Runtime("Map", "Set", "JSON"), allowfullscreen)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Allowfullscreen(allowfullscreen string) *Props {
	macro.Rewrite("$_.Set('allowfullscreen', $1)", allowfullscreen)
...
func Frameborder(frameborder string) *Props {
	macro.Rewrite("$1().Set('frameborder', $2)", js.Runtime("Map", "Set", "JSON"), frameborder)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Frameborder(frameborder string) *Props {
	macro.Rewrite("$_.Set('frameborder', $1)", frameborder)
...
func Longdesc(longdesc string) *Props {
	macro.Rewrite("$1().Set('longdesc', $2)", js.Runtime("Map", "Set", "JSON"), longdesc)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Longdesc(longdesc string) *Props {
	macro.Rewrite("$_.Set('longdesc', $1)", longdesc)
...
func Marginheight(marginheight string) *Props {
	macro.Rewrite("$1().Set('marginheight', $2)", js.Runtime("Map", "Set", "JSON"), marginheight)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Marginheight(marginheight string) *Props {
	macro.Rewrite("$_.Set('marginheight', $1)", marginheight)
...
func Marginwidth(marginwidth string) *Props {
	macro.Rewrite("$1().Set('marginwidth', $2)", js.Runtime("Map", "Set", "JSON"), marginwidth)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Marginwidth(marginwidth string) *Props {
	macro.Rewrite("$_.Set('marginwidth', $1)", marginwidth)
...
func Sandbox(sandbox string) *Props {
	macro.Rewrite("$1().Set('sandbox', $2)", js.Runtime("Map", "Set", "JSON"), sandbox)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Sandbox(sandbox string) *Props {
	macro.Rewrite("$_.Set('sandbox', $1)", sandbox)
...
func Scrolling(scrolling string) *Props {
	macro.Rewrite("$1().Set('scrolling', $2)", js.Runtime("Map", "Set", "JSON"), scrolling)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Scrolling(scrolling string) *Props {
	macro.Rewrite("$_.Set('scrolling', $1)", scrolling)
...
func Src(src string) *Props {
	macro.Rewrite("$1().Set('src', $2)", js.Runtime("Map", "Set", "JSON"), src)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Src(src)
}
...
func Srcdoc(srcdoc string) *Props {
	macro.Rewrite("$1().Set('srcdoc', $2)", js.Runtime("Map", "Set", "JSON"), srcdoc)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Srcdoc(srcdoc string) *Props {
	macro.Rewrite("$_.Set('srcdoc', $1)", srcdoc)
