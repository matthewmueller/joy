...
func Accept(accept string) *Props {
	macro.Rewrite("$1().Set('accept', $2)", js.Runtime("Map", "Set", "JSON"), accept)
	p := &Props{attrs: map[string]interface{}{}}
...
func Autocomplete(autocomplete string) *Props {
	macro.Rewrite("$1().Set('autocomplete', $2)", js.Runtime("Map", "Set", "JSON"), autocomplete)
	p := &Props{attrs: map[string]interface{}{}}
...
func Autofocus(autofocus string) *Props {
	macro.Rewrite("$1().Set('autofocus', $2)", js.Runtime("Map", "Set", "JSON"), autofocus)
	p := &Props{attrs: map[string]interface{}{}}
...
func Checked(checked string) *Props {
	macro.Rewrite("$1().Set('checked', $2)", js.Runtime("Map", "Set", "JSON"), checked)
	p := &Props{attrs: map[string]interface{}{}}
...
func Dirname(dirname string) *Props {
	macro.Rewrite("$1().Set('dirname', $2)", js.Runtime("Map", "Set", "JSON"), dirname)
	p := &Props{attrs: map[string]interface{}{}}
...
func Formaction(formaction string) *Props {
	macro.Rewrite("$1().Set('formaction', $2)", js.Runtime("Map", "Set", "JSON"), formaction)
	p := &Props{attrs: map[string]interface{}{}}
...
func Formenctype(formenctype string) *Props {
	macro.Rewrite("$1().Set('formenctype', $2)", js.Runtime("Map", "Set", "JSON"), formenctype)
	p := &Props{attrs: map[string]interface{}{}}
...
func Formmethod(formmethod string) *Props {
	macro.Rewrite("$1().Set('formmethod', $2)", js.Runtime("Map", "Set", "JSON"), formmethod)
	p := &Props{attrs: map[string]interface{}{}}
...
func Formnovalidate(formnovalidate string) *Props {
	macro.Rewrite("$1().Set('formnovalidate', $2)", js.Runtime("Map", "Set", "JSON"), formnovalidate)
	p := &Props{attrs: map[string]interface{}{}}
...
func Formtarget(formtarget string) *Props {
	macro.Rewrite("$1().Set('formtarget', $2)", js.Runtime("Map", "Set", "JSON"), formtarget)
	p := &Props{attrs: map[string]interface{}{}}
...
func Inputmode(inputmode string) *Props {
	macro.Rewrite("$1().Set('inputmode', $2)", js.Runtime("Map", "Set", "JSON"), inputmode)
	p := &Props{attrs: map[string]interface{}{}}
...
func List(list string) *Props {
	macro.Rewrite("$1().Set('list', $2)", js.Runtime("Map", "Set", "JSON"), list)
	p := &Props{attrs: map[string]interface{}{}}
	return p.List(list)
}
...
func Max(max string) *Props {
	macro.Rewrite("$1().Set('max', $2)", js.Runtime("Map", "Set", "JSON"), max)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Max(max)
}
...
func Maxlength(maxlength string) *Props {
	macro.Rewrite("$1().Set('maxlength', $2)", js.Runtime("Map", "Set", "JSON"), maxlength)
	p := &Props{attrs: map[string]interface{}{}}
...
func Min(min string) *Props {
	macro.Rewrite("$1().Set('min', $2)", js.Runtime("Map", "Set", "JSON"), min)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Min(min)
}
...
func Minlength(minlength string) *Props {
	macro.Rewrite("$1().Set('minlength', $2)", js.Runtime("Map", "Set", "JSON"), minlength)
	p := &Props{attrs: map[string]interface{}{}}
...
func Multiple(multiple string) *Props {
	macro.Rewrite("$1().Set('multiple', $2)", js.Runtime("Map", "Set", "JSON"), multiple)
	p := &Props{attrs: map[string]interface{}{}}
...
func Pattern(pattern string) *Props {
	macro.Rewrite("$1().Set('pattern', $2)", js.Runtime("Map", "Set", "JSON"), pattern)
	p := &Props{attrs: map[string]interface{}{}}
...
func Placeholder(placeholder string) *Props {
	macro.Rewrite("$1().Set('placeholder', $2)", js.Runtime("Map", "Set", "JSON"), placeholder)
	p := &Props{attrs: map[string]interface{}{}}
...
func Readonly(readonly string) *Props {
	macro.Rewrite("$1().Set('readonly', $2)", js.Runtime("Map", "Set", "JSON"), readonly)
	p := &Props{attrs: map[string]interface{}{}}
...
func Required(required string) *Props {
	macro.Rewrite("$1().Set('required', $2)", js.Runtime("Map", "Set", "JSON"), required)
	p := &Props{attrs: map[string]interface{}{}}
...
func Size(size string) *Props {
	macro.Rewrite("$1().Set('size', $2)", js.Runtime("Map", "Set", "JSON"), size)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Size(size)
}
...
func Step(step string) *Props {
	macro.Rewrite("$1().Set('step', $2)", js.Runtime("Map", "Set", "JSON"), step)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Step(step)
}
