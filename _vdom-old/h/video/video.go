...
func New(props *Props, children ...vdom.Child) *Video {
	macro.Rewrite("$1('video', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Autoplay(autoplay string) *Props {
	macro.Rewrite("$1().Set('autoplay', $2)", js.Runtime("Map", "Set", "JSON"), autoplay)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Autoplay(autoplay string) *Props {
	macro.Rewrite("$_.Set('autoplay', $1)", autoplay)
...
func Controls(controls string) *Props {
	macro.Rewrite("$1().Set('controls', $2)", js.Runtime("Map", "Set", "JSON"), controls)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Controls(controls string) *Props {
	macro.Rewrite("$_.Set('controls', $1)", controls)
...
func Loop(loop string) *Props {
	macro.Rewrite("$1().Set('loop', $2)", js.Runtime("Map", "Set", "JSON"), loop)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Loop(loop)
}
...
func (p *Props) Loop(loop string) *Props {
	macro.Rewrite("$_.Set('loop', $1)", loop)
	p.attrs["loop"] = loop
	return p
}
...
func Mediagroup(mediagroup string) *Props {
	macro.Rewrite("$1().Set('mediagroup', $2)", js.Runtime("Map", "Set", "JSON"), mediagroup)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Mediagroup(mediagroup string) *Props {
	macro.Rewrite("$_.Set('mediagroup', $1)", mediagroup)
...
func Muted(muted string) *Props {
	macro.Rewrite("$1().Set('muted', $2)", js.Runtime("Map", "Set", "JSON"), muted)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Muted(muted string) *Props {
	macro.Rewrite("$_.Set('muted', $1)", muted)
	p.attrs["muted"] = muted
	return p
}
...
func Poster(poster string) *Props {
	macro.Rewrite("$1().Set('poster', $2)", js.Runtime("Map", "Set", "JSON"), poster)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Poster(poster string) *Props {
	macro.Rewrite("$_.Set('poster', $1)", poster)
...
func Preload(preload string) *Props {
	macro.Rewrite("$1().Set('preload', $2)", js.Runtime("Map", "Set", "JSON"), preload)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Preload(preload string) *Props {
	macro.Rewrite("$_.Set('preload', $1)", preload)
