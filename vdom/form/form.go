...
func AcceptCharset(acceptCharset string) *Props {
	macro.Rewrite("$1().Set('accept-charset', $2)", macro.Runtime("Map", "Set", "JSON"), acceptCharset)
...
func (p *Props) AcceptCharset(acceptCharset string) *Props {
	macro.Rewrite("$_.Set('accept-charset', $1)", acceptCharset)
...
func Action(action string) *Props {
	macro.Rewrite("$1().Set('action', $2)", macro.Runtime("Map", "Set", "JSON"), action)
	p := &Props{attrs: map[string]interface{}{}}
...
func Enctype(enctype string) *Props {
	macro.Rewrite("$1().Set('enctype', $2)", macro.Runtime("Map", "Set", "JSON"), enctype)
	p := &Props{attrs: map[string]interface{}{}}
...
func Method(method string) *Props {
	macro.Rewrite("$1().Set('method', $2)", macro.Runtime("Map", "Set", "JSON"), method)
	p := &Props{attrs: map[string]interface{}{}}
...
func Novalidate(novalidate string) *Props {
	macro.Rewrite("$1().Set('novalidate', $2)", macro.Runtime("Map", "Set", "JSON"), novalidate)
	p := &Props{attrs: map[string]interface{}{}}
