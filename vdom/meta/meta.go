...
func HTTPEquiv(httpEquiv string) *Props {
	macro.Rewrite("$1().Set('http-equiv', $2)", macro.Runtime("Map", "Set", "JSON"), httpEquiv)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) HTTPEquiv(httpEquiv string) *Props {
	macro.Rewrite("$_.Set('http-equiv', $1)", httpEquiv)
...
func Content(content string) *Props {
	macro.Rewrite("$1().Set('content', $2)", macro.Runtime("Map", "Set", "JSON"), content)
	p := &Props{attrs: map[string]interface{}{}}
