...
func Charset(charset string) *Props {
	macro.Rewrite("$1().Set('charset', $2)", macro.Runtime("Map", "Set", "JSON"), charset)
	p := &Props{attrs: map[string]interface{}{}}
...
func Async(async string) *Props {
	macro.Rewrite("$1().Set('async', $2)", macro.Runtime("Map", "Set", "JSON"), async)
	p := &Props{attrs: map[string]interface{}{}}
...
func Defer(dfr string) *Props {
	macro.Rewrite("$1().Set('dfr', $2)", macro.Runtime("Map", "Set", "JSON"), dfr)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Defer(dfr)
}
...
func Nonce(nonce string) *Props {
	macro.Rewrite("$1().Set('nonce', $2)", macro.Runtime("Map", "Set", "JSON"), nonce)
	p := &Props{attrs: map[string]interface{}{}}
