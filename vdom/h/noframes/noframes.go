...
// New fn
func New(props *Props, children ...vdom.Child) *Noframes {
	js.Rewrite("$1('noframes', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Noframes) Render() vdom.Node {
	return s
}

func (s *Noframes) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<noframes " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</noframes>"
	}

	return "<noframes>" + strings.Join(children, "") + "</noframes>"
}
