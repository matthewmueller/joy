...
// Render fn
func (s *Keygen) Render() vdom.Node {
	return s
}

func (s *Keygen) String() string {
	// props
	var props []string
...
// Challenge fn
func Challenge(challenge string) *Props {
	js.Rewrite("$1().Set('challenge', $2)", js.Runtime("Map", "Set", "JSON"), challenge)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Challenge(challenge)
}

// Challenge fn
func (p *Props) Challenge(challenge string) *Props {
	js.Rewrite("$_.Set('challenge', $1)", challenge)
	p.attrs["challenge"] = challenge
	return p
}
...
// Keytype fn
func Keytype(keytype string) *Props {
	js.Rewrite("$1().Set('keytype', $2)", js.Runtime("Map", "Set", "JSON"), keytype)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Keytype(keytype)
}

// Keytype fn
func (p *Props) Keytype(keytype string) *Props {
	js.Rewrite("$_.Set('keytype', $1)", keytype)
	p.attrs["keytype"] = keytype
	return p
}
