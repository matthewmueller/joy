...
// New fn
func New(props *Props, children ...vdom.Child) *Rtc {
	js.Rewrite("$1('rtc', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Rtc) String() string {
	...
	if len(props) > 0 {
		return "<rtc " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</rtc>"
	}

	return "<rtc>" + strings.Join(children, "") + "</rtc>"
}
