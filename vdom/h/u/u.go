...
// New fn
func New(props *Props, children ...vdom.Child) *U {
	js.Rewrite("$1('u', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *U) Render() vdom.Node {
	return s
}

func (s *U) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<u " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</u>"
	}

	return "<u>" + strings.Join(children, "") + "</u>"
}
