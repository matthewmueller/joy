...
// Manifest fn
func Manifest(manifest string) *Props {
	js.Rewrite("$1().Set('manifest', $2)", js.Runtime("Map", "Set", "JSON"), manifest)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Manifest(manifest)
}

// Manifest fn
func (p *Props) Manifest(manifest string) *Props {
	js.Rewrite("$_.Set('manifest', $1)", manifest)
	p.attrs["manifest"] = manifest
	return p
}

// Version fn
func Version(version string) *Props {
	js.Rewrite("$1().Set('version', $2)", js.Runtime("Map", "Set", "JSON"), version)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Version(version)
}

// Version fn
func (p *Props) Version(version string) *Props {
	js.Rewrite("$_.Set('version', $1)", version)
	p.attrs["version"] = version
	return p
}
