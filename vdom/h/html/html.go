...
func New(props *Props, children ...vdom.Child) *HTML {
	macro.Rewrite("$1('html', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Manifest(manifest string) *Props {
	macro.Rewrite("$1().Set('manifest', $2)", js.Runtime("Map", "Set", "JSON"), manifest)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Manifest(manifest string) *Props {
	macro.Rewrite("$_.Set('manifest', $1)", manifest)
...
func Version(version string) *Props {
	macro.Rewrite("$1().Set('version', $2)", js.Runtime("Map", "Set", "JSON"), version)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Version(version string) *Props {
	macro.Rewrite("$_.Set('version', $1)", version)
