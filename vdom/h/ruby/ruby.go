...
// New fn
func New(props *Props, children ...vdom.Child) *Ruby {
	js.Rewrite("$1('ruby', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Ruby) Render() vdom.Node {
	return s
}

func (s *Ruby) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<ruby " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</ruby>"
	}

	return "<ruby>" + strings.Join(children, "") + "</ruby>"
}
