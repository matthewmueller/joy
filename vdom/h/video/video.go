...
// New fn
func New(props *Props, children ...vdom.Child) *Video {
	js.Rewrite("$1('video', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Video) String() string {
	...
	if len(props) > 0 {
		return "<video " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</video>"
	}

	return "<video>" + strings.Join(children, "") + "</video>"
}
...
// Autoplay fn
func Autoplay(autoplay string) *Props {
	js.Rewrite("$1().Set('autoplay', $2)", js.Runtime("Map", "Set", "JSON"), autoplay)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Autoplay(autoplay)
}

// Autoplay fn
func (p *Props) Autoplay(autoplay string) *Props {
	js.Rewrite("$_.Set('autoplay', $1)", autoplay)
	p.attrs["autoplay"] = autoplay
	return p
}

// Controls fn
func Controls(controls string) *Props {
	js.Rewrite("$1().Set('controls', $2)", js.Runtime("Map", "Set", "JSON"), controls)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Controls(controls)
}

// Controls fn
func (p *Props) Controls(controls string) *Props {
	js.Rewrite("$_.Set('controls', $1)", controls)
	p.attrs["controls"] = controls
	return p
}
...
// Loop fn
func Loop(loop string) *Props {
	js.Rewrite("$1().Set('loop', $2)", js.Runtime("Map", "Set", "JSON"), loop)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Loop(loop)
}

// Loop fn
func (p *Props) Loop(loop string) *Props {
	js.Rewrite("$_.Set('loop', $1)", loop)
	p.attrs["loop"] = loop
	return p
}

// Mediagroup fn
func Mediagroup(mediagroup string) *Props {
	js.Rewrite("$1().Set('mediagroup', $2)", js.Runtime("Map", "Set", "JSON"), mediagroup)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Mediagroup(mediagroup)
}

// Mediagroup fn
func (p *Props) Mediagroup(mediagroup string) *Props {
	js.Rewrite("$_.Set('mediagroup', $1)", mediagroup)
	p.attrs["mediagroup"] = mediagroup
	return p
}

// Muted fn
func Muted(muted string) *Props {
	js.Rewrite("$1().Set('muted', $2)", js.Runtime("Map", "Set", "JSON"), muted)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Muted(muted)
}

// Muted fn
func (p *Props) Muted(muted string) *Props {
	js.Rewrite("$_.Set('muted', $1)", muted)
	p.attrs["muted"] = muted
	return p
}

// Poster fn
func Poster(poster string) *Props {
	js.Rewrite("$1().Set('poster', $2)", js.Runtime("Map", "Set", "JSON"), poster)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Poster(poster)
}

// Poster fn
func (p *Props) Poster(poster string) *Props {
	js.Rewrite("$_.Set('poster', $1)", poster)
	p.attrs["poster"] = poster
	return p
}

// Preload fn
func Preload(preload string) *Props {
	js.Rewrite("$1().Set('preload', $2)", js.Runtime("Map", "Set", "JSON"), preload)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Preload(preload)
}

// Preload fn
func (p *Props) Preload(preload string) *Props {
	js.Rewrite("$_.Set('preload', $1)", preload)
	p.attrs["preload"] = preload
	return p
}
