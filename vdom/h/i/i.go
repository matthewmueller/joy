...
// New fn
func New(props *Props, children ...vdom.Child) *I {
	js.Rewrite("$1('i', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *I) String() string {
	...
	if len(props) > 0 {
		return "<i " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</i>"
	}

	return "<i>" + strings.Join(children, "") + "</i>"
}
