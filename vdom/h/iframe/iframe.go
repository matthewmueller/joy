...
// New fn
func New(props *Props, children ...vdom.Child) *Iframe {
	js.Rewrite("$1('iframe', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Iframe) Render() vdom.Node {
	return s
}

func (s *Iframe) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<iframe " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</iframe>"
	}

	return "<iframe>" + strings.Join(children, "") + "</iframe>"
}
...
// Allowfullscreen fn
func Allowfullscreen(allowfullscreen string) *Props {
	js.Rewrite("$1().Set('allowfullscreen', $2)", js.Runtime("Map", "Set", "JSON"), allowfullscreen)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Allowfullscreen(allowfullscreen)
}

// Allowfullscreen fn
func (p *Props) Allowfullscreen(allowfullscreen string) *Props {
	js.Rewrite("$_.Set('allowfullscreen', $1)", allowfullscreen)
	p.attrs["allowfullscreen"] = allowfullscreen
	return p
}

// Frameborder fn
func Frameborder(frameborder string) *Props {
	js.Rewrite("$1().Set('frameborder', $2)", js.Runtime("Map", "Set", "JSON"), frameborder)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Frameborder(frameborder)
}

// Frameborder fn
func (p *Props) Frameborder(frameborder string) *Props {
	js.Rewrite("$_.Set('frameborder', $1)", frameborder)
	p.attrs["frameborder"] = frameborder
	return p
}
...
// Longdesc fn
func Longdesc(longdesc string) *Props {
	js.Rewrite("$1().Set('longdesc', $2)", js.Runtime("Map", "Set", "JSON"), longdesc)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Longdesc(longdesc)
}

// Longdesc fn
func (p *Props) Longdesc(longdesc string) *Props {
	js.Rewrite("$_.Set('longdesc', $1)", longdesc)
	p.attrs["longdesc"] = longdesc
	return p
}

// Marginheight fn
func Marginheight(marginheight string) *Props {
	js.Rewrite("$1().Set('marginheight', $2)", js.Runtime("Map", "Set", "JSON"), marginheight)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Marginheight(marginheight)
}

// Marginheight fn
func (p *Props) Marginheight(marginheight string) *Props {
	js.Rewrite("$_.Set('marginheight', $1)", marginheight)
	p.attrs["marginheight"] = marginheight
	return p
}

// Marginwidth fn
func Marginwidth(marginwidth string) *Props {
	js.Rewrite("$1().Set('marginwidth', $2)", js.Runtime("Map", "Set", "JSON"), marginwidth)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Marginwidth(marginwidth)
}

// Marginwidth fn
func (p *Props) Marginwidth(marginwidth string) *Props {
	js.Rewrite("$_.Set('marginwidth', $1)", marginwidth)
	p.attrs["marginwidth"] = marginwidth
	return p
}
...
// Sandbox fn
func Sandbox(sandbox string) *Props {
	js.Rewrite("$1().Set('sandbox', $2)", js.Runtime("Map", "Set", "JSON"), sandbox)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Sandbox(sandbox)
}

// Sandbox fn
func (p *Props) Sandbox(sandbox string) *Props {
	js.Rewrite("$_.Set('sandbox', $1)", sandbox)
	p.attrs["sandbox"] = sandbox
	return p
}

// Scrolling fn
func Scrolling(scrolling string) *Props {
	js.Rewrite("$1().Set('scrolling', $2)", js.Runtime("Map", "Set", "JSON"), scrolling)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Scrolling(scrolling)
}

// Scrolling fn
func (p *Props) Scrolling(scrolling string) *Props {
	js.Rewrite("$_.Set('scrolling', $1)", scrolling)
	p.attrs["scrolling"] = scrolling
	return p
}
...
// Srcdoc fn
func Srcdoc(srcdoc string) *Props {
	js.Rewrite("$1().Set('srcdoc', $2)", js.Runtime("Map", "Set", "JSON"), srcdoc)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Srcdoc(srcdoc)
}

// Srcdoc fn
func (p *Props) Srcdoc(srcdoc string) *Props {
	js.Rewrite("$_.Set('srcdoc', $1)", srcdoc)
	p.attrs["srcdoc"] = srcdoc
	return p
}
