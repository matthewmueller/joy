...
func New(props *Props, children ...vdom.Child) *A {
	macro.Rewrite("$1('a', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Charset(charset string) *Props {
	macro.Rewrite("$1().Set('charset', $2)", js.Runtime("Map", "Set", "JSON"), charset)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Charset(charset string) *Props {
	macro.Rewrite("$_.Set('charset', $1)", charset)
...
func Coords(coords string) *Props {
	macro.Rewrite("$1().Set('coords', $2)", js.Runtime("Map", "Set", "JSON"), coords)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Coords(coords string) *Props {
	macro.Rewrite("$_.Set('coords', $1)", coords)
...
func Download(download string) *Props {
	macro.Rewrite("$1().Set('download', $2)", js.Runtime("Map", "Set", "JSON"), download)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Download(download string) *Props {
	macro.Rewrite("$_.Set('download', $1)", download)
...
func Href(href string) *Props {
	macro.Rewrite("$1().Set('href', $2)", js.Runtime("Map", "Set", "JSON"), href)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Href(href)
}
...
func (p *Props) Href(href string) *Props {
	macro.Rewrite("$_.Set('href', $1)", href)
	p.attrs["href"] = href
	return p
}
...
func Hreflang(hreflang string) *Props {
	macro.Rewrite("$1().Set('hreflang', $2)", js.Runtime("Map", "Set", "JSON"), hreflang)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Hreflang(hreflang string) *Props {
	macro.Rewrite("$_.Set('hreflang', $1)", hreflang)
...
func Ping(ping string) *Props {
	macro.Rewrite("$1().Set('ping', $2)", js.Runtime("Map", "Set", "JSON"), ping)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Ping(ping)
}
...
func (p *Props) Ping(ping string) *Props {
	macro.Rewrite("$_.Set('ping', $1)", ping)
	p.attrs["ping"] = ping
	return p
}
...
func Rel(rel string) *Props {
	macro.Rewrite("$1().Set('rel', $2)", js.Runtime("Map", "Set", "JSON"), rel)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Rel(rel)
}
...
func Rev(rev string) *Props {
	macro.Rewrite("$1().Set('rev', $2)", js.Runtime("Map", "Set", "JSON"), rev)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Rev(rev)
}
...
func Shape(shape string) *Props {
	macro.Rewrite("$1().Set('shape', $2)", js.Runtime("Map", "Set", "JSON"), shape)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Shape(shape string) *Props {
	macro.Rewrite("$_.Set('shape', $1)", shape)
	p.attrs["shape"] = shape
	return p
}
...
func Target(target string) *Props {
	macro.Rewrite("$1().Set('target', $2)", js.Runtime("Map", "Set", "JSON"), target)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Target(target string) *Props {
	macro.Rewrite("$_.Set('target', $1)", target)
