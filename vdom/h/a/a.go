...
// New fn
func New(props *Props, children ...vdom.Child) *A {
	js.Rewrite("$1('a', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *A) String() string {
	...
	if len(props) > 0 {
		return "<a " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</a>"
	}

	return "<a>" + strings.Join(children, "") + "</a>"
}
...
// Charset fn
func Charset(charset string) *Props {
	js.Rewrite("$1().Set('charset', $2)", js.Runtime("Map", "Set", "JSON"), charset)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Charset(charset)
}

// Charset fn
func (p *Props) Charset(charset string) *Props {
	js.Rewrite("$_.Set('charset', $1)", charset)
	p.attrs["charset"] = charset
	return p
}

// Coords fn
func Coords(coords string) *Props {
	js.Rewrite("$1().Set('coords', $2)", js.Runtime("Map", "Set", "JSON"), coords)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Coords(coords)
}

// Coords fn
func (p *Props) Coords(coords string) *Props {
	js.Rewrite("$_.Set('coords', $1)", coords)
	p.attrs["coords"] = coords
	return p
}

// Download fn
func Download(download string) *Props {
	js.Rewrite("$1().Set('download', $2)", js.Runtime("Map", "Set", "JSON"), download)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Download(download)
}

// Download fn
func (p *Props) Download(download string) *Props {
	js.Rewrite("$_.Set('download', $1)", download)
	p.attrs["download"] = download
	return p
}

// Href fn
func Href(href string) *Props {
	js.Rewrite("$1().Set('href', $2)", js.Runtime("Map", "Set", "JSON"), href)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Href(href)
}

// Href fn
func (p *Props) Href(href string) *Props {
	js.Rewrite("$_.Set('href', $1)", href)
	p.attrs["href"] = href
	return p
}

// Hreflang fn
func Hreflang(hreflang string) *Props {
	js.Rewrite("$1().Set('hreflang', $2)", js.Runtime("Map", "Set", "JSON"), hreflang)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Hreflang(hreflang)
}

// Hreflang fn
func (p *Props) Hreflang(hreflang string) *Props {
	js.Rewrite("$_.Set('hreflang', $1)", hreflang)
	p.attrs["hreflang"] = hreflang
	return p
}
...
// Ping fn
func Ping(ping string) *Props {
	js.Rewrite("$1().Set('ping', $2)", js.Runtime("Map", "Set", "JSON"), ping)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Ping(ping)
}

// Ping fn
func (p *Props) Ping(ping string) *Props {
	js.Rewrite("$_.Set('ping', $1)", ping)
	p.attrs["ping"] = ping
	return p
}

// Rel fn
func Rel(rel string) *Props {
	js.Rewrite("$1().Set('rel', $2)", js.Runtime("Map", "Set", "JSON"), rel)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Rel(rel)
}

// Rel fn
func (p *Props) Rel(rel string) *Props {
	js.Rewrite("$_.Set('rel', $1)", rel)
	p.attrs["rel"] = rel
	return p
}

// Rev fn
func Rev(rev string) *Props {
	js.Rewrite("$1().Set('rev', $2)", js.Runtime("Map", "Set", "JSON"), rev)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Rev(rev)
}

// Rev fn
func (p *Props) Rev(rev string) *Props {
	js.Rewrite("$_.Set('rev', $1)", rev)
	p.attrs["rev"] = rev
	return p
}

// Shape fn
func Shape(shape string) *Props {
	js.Rewrite("$1().Set('shape', $2)", js.Runtime("Map", "Set", "JSON"), shape)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Shape(shape)
}

// Shape fn
func (p *Props) Shape(shape string) *Props {
	js.Rewrite("$_.Set('shape', $1)", shape)
	p.attrs["shape"] = shape
	return p
}

// Target fn
func Target(target string) *Props {
	js.Rewrite("$1().Set('target', $2)", js.Runtime("Map", "Set", "JSON"), target)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Target(target)
}

// Target fn
func (p *Props) Target(target string) *Props {
	js.Rewrite("$_.Set('target', $1)", target)
	p.attrs["target"] = target
	return p
}
