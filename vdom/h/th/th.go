...
func New(props *Props, children ...vdom.Child) *Th {
	macro.Rewrite("$1('th', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Abbr(abbr string) *Props {
	macro.Rewrite("$1().Set('abbr', $2)", js.Runtime("Map", "Set", "JSON"), abbr)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Abbr(abbr)
}
...
func (p *Props) Abbr(abbr string) *Props {
	macro.Rewrite("$_.Set('abbr', $1)", abbr)
	p.attrs["abbr"] = abbr
	return p
}
...
func Axis(axis string) *Props {
	macro.Rewrite("$1().Set('axis', $2)", js.Runtime("Map", "Set", "JSON"), axis)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Axis(axis)
}
...
func (p *Props) Axis(axis string) *Props {
	macro.Rewrite("$_.Set('axis', $1)", axis)
	p.attrs["axis"] = axis
	return p
}
...
func Bgcolor(bgcolor string) *Props {
	macro.Rewrite("$1().Set('bgcolor', $2)", js.Runtime("Map", "Set", "JSON"), bgcolor)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Bgcolor(bgcolor string) *Props {
	macro.Rewrite("$_.Set('bgcolor', $1)", bgcolor)
...
func Char(char string) *Props {
	macro.Rewrite("$1().Set('char', $2)", js.Runtime("Map", "Set", "JSON"), char)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Char(char)
}
...
func (p *Props) Char(char string) *Props {
	macro.Rewrite("$_.Set('char', $1)", char)
	p.attrs["char"] = char
	return p
}
...
func Charoff(charoff string) *Props {
	macro.Rewrite("$1().Set('charoff', $2)", js.Runtime("Map", "Set", "JSON"), charoff)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Charoff(charoff string) *Props {
	macro.Rewrite("$_.Set('charoff', $1)", charoff)
...
func Colspan(colspan string) *Props {
	macro.Rewrite("$1().Set('colspan', $2)", js.Runtime("Map", "Set", "JSON"), colspan)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Colspan(colspan string) *Props {
	macro.Rewrite("$_.Set('colspan', $1)", colspan)
...
func Headers(headers string) *Props {
	macro.Rewrite("$1().Set('headers', $2)", js.Runtime("Map", "Set", "JSON"), headers)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Headers(headers string) *Props {
	macro.Rewrite("$_.Set('headers', $1)", headers)
...
func Nowrap(nowrap string) *Props {
	macro.Rewrite("$1().Set('nowrap', $2)", js.Runtime("Map", "Set", "JSON"), nowrap)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Nowrap(nowrap string) *Props {
	macro.Rewrite("$_.Set('nowrap', $1)", nowrap)
...
func Rowspan(rowspan string) *Props {
	macro.Rewrite("$1().Set('rowspan', $2)", js.Runtime("Map", "Set", "JSON"), rowspan)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Rowspan(rowspan string) *Props {
	macro.Rewrite("$_.Set('rowspan', $1)", rowspan)
...
func Scope(scope string) *Props {
	macro.Rewrite("$1().Set('scope', $2)", js.Runtime("Map", "Set", "JSON"), scope)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Scope(scope string) *Props {
	macro.Rewrite("$_.Set('scope', $1)", scope)
	p.attrs["scope"] = scope
	return p
}
...
func Valign(valign string) *Props {
	macro.Rewrite("$1().Set('valign', $2)", js.Runtime("Map", "Set", "JSON"), valign)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Valign(valign string) *Props {
	macro.Rewrite("$_.Set('valign', $1)", valign)
