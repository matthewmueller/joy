...
// New fn
func New(props *Props, children ...vdom.Child) *Th {
	js.Rewrite("$1('th', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Th) Render() vdom.Node {
	return s
}

func (s *Th) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<th " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</th>"
	}

	return "<th>" + strings.Join(children, "") + "</th>"
}
...
// Abbr fn
func Abbr(abbr string) *Props {
	js.Rewrite("$1().Set('abbr', $2)", js.Runtime("Map", "Set", "JSON"), abbr)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Abbr(abbr)
}

// Abbr fn
func (p *Props) Abbr(abbr string) *Props {
	js.Rewrite("$_.Set('abbr', $1)", abbr)
	p.attrs["abbr"] = abbr
	return p
}
...
// Axis fn
func Axis(axis string) *Props {
	js.Rewrite("$1().Set('axis', $2)", js.Runtime("Map", "Set", "JSON"), axis)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Axis(axis)
}

// Axis fn
func (p *Props) Axis(axis string) *Props {
	js.Rewrite("$_.Set('axis', $1)", axis)
	p.attrs["axis"] = axis
	return p
}

// Bgcolor fn
func Bgcolor(bgcolor string) *Props {
	js.Rewrite("$1().Set('bgcolor', $2)", js.Runtime("Map", "Set", "JSON"), bgcolor)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Bgcolor(bgcolor)
}

// Bgcolor fn
func (p *Props) Bgcolor(bgcolor string) *Props {
	js.Rewrite("$_.Set('bgcolor', $1)", bgcolor)
	p.attrs["bgcolor"] = bgcolor
	return p
}

// Char fn
func Char(char string) *Props {
	js.Rewrite("$1().Set('char', $2)", js.Runtime("Map", "Set", "JSON"), char)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Char(char)
}

// Char fn
func (p *Props) Char(char string) *Props {
	js.Rewrite("$_.Set('char', $1)", char)
	p.attrs["char"] = char
	return p
}

// Charoff fn
func Charoff(charoff string) *Props {
	js.Rewrite("$1().Set('charoff', $2)", js.Runtime("Map", "Set", "JSON"), charoff)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Charoff(charoff)
}

// Charoff fn
func (p *Props) Charoff(charoff string) *Props {
	js.Rewrite("$_.Set('charoff', $1)", charoff)
	p.attrs["charoff"] = charoff
	return p
}

// Colspan fn
func Colspan(colspan string) *Props {
	js.Rewrite("$1().Set('colspan', $2)", js.Runtime("Map", "Set", "JSON"), colspan)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Colspan(colspan)
}

// Colspan fn
func (p *Props) Colspan(colspan string) *Props {
	js.Rewrite("$_.Set('colspan', $1)", colspan)
	p.attrs["colspan"] = colspan
	return p
}

// Headers fn
func Headers(headers string) *Props {
	js.Rewrite("$1().Set('headers', $2)", js.Runtime("Map", "Set", "JSON"), headers)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Headers(headers)
}

// Headers fn
func (p *Props) Headers(headers string) *Props {
	js.Rewrite("$_.Set('headers', $1)", headers)
	p.attrs["headers"] = headers
	return p
}
...
// Nowrap fn
func Nowrap(nowrap string) *Props {
	js.Rewrite("$1().Set('nowrap', $2)", js.Runtime("Map", "Set", "JSON"), nowrap)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Nowrap(nowrap)
}

// Nowrap fn
func (p *Props) Nowrap(nowrap string) *Props {
	js.Rewrite("$_.Set('nowrap', $1)", nowrap)
	p.attrs["nowrap"] = nowrap
	return p
}

// Rowspan fn
func Rowspan(rowspan string) *Props {
	js.Rewrite("$1().Set('rowspan', $2)", js.Runtime("Map", "Set", "JSON"), rowspan)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Rowspan(rowspan)
}

// Rowspan fn
func (p *Props) Rowspan(rowspan string) *Props {
	js.Rewrite("$_.Set('rowspan', $1)", rowspan)
	p.attrs["rowspan"] = rowspan
	return p
}

// Scope fn
func Scope(scope string) *Props {
	js.Rewrite("$1().Set('scope', $2)", js.Runtime("Map", "Set", "JSON"), scope)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Scope(scope)
}

// Scope fn
func (p *Props) Scope(scope string) *Props {
	js.Rewrite("$_.Set('scope', $1)", scope)
	p.attrs["scope"] = scope
	return p
}

// Valign fn
func Valign(valign string) *Props {
	js.Rewrite("$1().Set('valign', $2)", js.Runtime("Map", "Set", "JSON"), valign)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Valign(valign)
}

// Valign fn
func (p *Props) Valign(valign string) *Props {
	js.Rewrite("$_.Set('valign', $1)", valign)
	p.attrs["valign"] = valign
	return p
}
