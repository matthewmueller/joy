...
// New fn
func New(props *Props, children ...vdom.Child) *Tr {
	js.Rewrite("$1('tr', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Tr) Render() vdom.Node {
	return s
}

func (s *Tr) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<tr " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</tr>"
	}

	return "<tr>" + strings.Join(children, "") + "</tr>"
}
