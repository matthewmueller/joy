...
func New(props *Props, children ...vdom.Child) *Object {
	macro.Rewrite("$1('object', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Align(align string) *Props {
	macro.Rewrite("$1().Set('align', $2)", js.Runtime("Map", "Set", "JSON"), align)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Align(align string) *Props {
	macro.Rewrite("$_.Set('align', $1)", align)
	p.attrs["align"] = align
	return p
}
...
func Archive(archive string) *Props {
	macro.Rewrite("$1().Set('archive', $2)", js.Runtime("Map", "Set", "JSON"), archive)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Archive(archive string) *Props {
	macro.Rewrite("$_.Set('archive', $1)", archive)
...
func Border(border string) *Props {
	macro.Rewrite("$1().Set('border', $2)", js.Runtime("Map", "Set", "JSON"), border)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Border(border string) *Props {
	macro.Rewrite("$_.Set('border', $1)", border)
...
func Classid(classid string) *Props {
	macro.Rewrite("$1().Set('classid', $2)", js.Runtime("Map", "Set", "JSON"), classid)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Classid(classid string) *Props {
	macro.Rewrite("$_.Set('classid', $1)", classid)
...
func Codebase(codebase string) *Props {
	macro.Rewrite("$1().Set('codebase', $2)", js.Runtime("Map", "Set", "JSON"), codebase)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Codebase(codebase string) *Props {
	macro.Rewrite("$_.Set('codebase', $1)", codebase)
...
func Codetype(codetype string) *Props {
	macro.Rewrite("$1().Set('codetype', $2)", js.Runtime("Map", "Set", "JSON"), codetype)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Codetype(codetype string) *Props {
	macro.Rewrite("$_.Set('codetype', $1)", codetype)
...
func Data(data string) *Props {
	macro.Rewrite("$1().Set('data', $2)", js.Runtime("Map", "Set", "JSON"), data)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Data(data)
}
...
func (p *Props) Data(data string) *Props {
	macro.Rewrite("$_.Set('data', $1)", data)
	p.attrs["data"] = data
	return p
}
...
func Declare(declare string) *Props {
	macro.Rewrite("$1().Set('declare', $2)", js.Runtime("Map", "Set", "JSON"), declare)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Declare(declare string) *Props {
	macro.Rewrite("$_.Set('declare', $1)", declare)
...
func Form(form string) *Props {
	macro.Rewrite("$1().Set('form', $2)", js.Runtime("Map", "Set", "JSON"), form)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Form(form)
}
...
func Height(height string) *Props {
	macro.Rewrite("$1().Set('height', $2)", js.Runtime("Map", "Set", "JSON"), height)
	p := &Props{attrs: map[string]interface{}{}}
...
func Hspace(hspace string) *Props {
	macro.Rewrite("$1().Set('hspace', $2)", js.Runtime("Map", "Set", "JSON"), hspace)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Hspace(hspace string) *Props {
	macro.Rewrite("$_.Set('hspace', $1)", hspace)
...
func Name(name string) *Props {
	macro.Rewrite("$1().Set('name', $2)", js.Runtime("Map", "Set", "JSON"), name)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Name(name)
}
...
func Standby(standby string) *Props {
	macro.Rewrite("$1().Set('standby', $2)", js.Runtime("Map", "Set", "JSON"), standby)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Standby(standby string) *Props {
	macro.Rewrite("$_.Set('standby', $1)", standby)
...
func Type(kind string) *Props {
	macro.Rewrite("$1().Set('kind', $2)", js.Runtime("Map", "Set", "JSON"), kind)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Type(kind)
}
...
func (p *Props) Type(kind string) *Props {
	macro.Rewrite("$_.Set('kind', $1)", kind)
	p.attrs["type"] = kind
	return p
}
...
func Typemustmatch(typemustmatch string) *Props {
	macro.Rewrite("$1().Set('typemustmatch', $2)", js.Runtime("Map", "Set", "JSON"), typemustmatch)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Typemustmatch(typemustmatch string) *Props {
	macro.Rewrite("$_.Set('typemustmatch', $1)", typemustmatch)
...
func Usemap(usemap string) *Props {
	macro.Rewrite("$1().Set('usemap', $2)", js.Runtime("Map", "Set", "JSON"), usemap)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Usemap(usemap string) *Props {
	macro.Rewrite("$_.Set('usemap', $1)", usemap)
...
func Vspace(vspace string) *Props {
	macro.Rewrite("$1().Set('vspace', $2)", js.Runtime("Map", "Set", "JSON"), vspace)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Vspace(vspace string) *Props {
	macro.Rewrite("$_.Set('vspace', $1)", vspace)
...
func Width(width string) *Props {
	macro.Rewrite("$1().Set('width', $2)", js.Runtime("Map", "Set", "JSON"), width)
	p := &Props{attrs: map[string]interface{}{}}
