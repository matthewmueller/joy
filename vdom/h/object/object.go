...
// New fn
func New(props *Props, children ...vdom.Child) *Object {
	js.Rewrite("$1('object', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Object) Render() vdom.Node {
	return s
}
...
func (s *Object) String() string {
	...
	if len(props) > 0 {
		return "<object " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</object>"
	}

	return "<object>" + strings.Join(children, "") + "</object>"
}
...
// Archive fn
func Archive(archive string) *Props {
	js.Rewrite("$1().Set('archive', $2)", js.Runtime("Map", "Set", "JSON"), archive)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Archive(archive)
}

// Archive fn
func (p *Props) Archive(archive string) *Props {
	js.Rewrite("$_.Set('archive', $1)", archive)
	p.attrs["archive"] = archive
	return p
}

// Border fn
func Border(border string) *Props {
	js.Rewrite("$1().Set('border', $2)", js.Runtime("Map", "Set", "JSON"), border)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Border(border)
}

// Border fn
func (p *Props) Border(border string) *Props {
	js.Rewrite("$_.Set('border', $1)", border)
	p.attrs["border"] = border
	return p
}

// Classid fn
func Classid(classid string) *Props {
	js.Rewrite("$1().Set('classid', $2)", js.Runtime("Map", "Set", "JSON"), classid)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Classid(classid)
}

// Classid fn
func (p *Props) Classid(classid string) *Props {
	js.Rewrite("$_.Set('classid', $1)", classid)
	p.attrs["classid"] = classid
	return p
}

// Codebase fn
func Codebase(codebase string) *Props {
	js.Rewrite("$1().Set('codebase', $2)", js.Runtime("Map", "Set", "JSON"), codebase)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Codebase(codebase)
}

// Codebase fn
func (p *Props) Codebase(codebase string) *Props {
	js.Rewrite("$_.Set('codebase', $1)", codebase)
	p.attrs["codebase"] = codebase
	return p
}

// Codetype fn
func Codetype(codetype string) *Props {
	js.Rewrite("$1().Set('codetype', $2)", js.Runtime("Map", "Set", "JSON"), codetype)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Codetype(codetype)
}

// Codetype fn
func (p *Props) Codetype(codetype string) *Props {
	js.Rewrite("$_.Set('codetype', $1)", codetype)
	p.attrs["codetype"] = codetype
	return p
}

// Data fn
func Data(data string) *Props {
	js.Rewrite("$1().Set('data', $2)", js.Runtime("Map", "Set", "JSON"), data)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Data(data)
}

// Data fn
func (p *Props) Data(data string) *Props {
	js.Rewrite("$_.Set('data', $1)", data)
	p.attrs["data"] = data
	return p
}

// Declare fn
func Declare(declare string) *Props {
	js.Rewrite("$1().Set('declare', $2)", js.Runtime("Map", "Set", "JSON"), declare)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Declare(declare)
}

// Declare fn
func (p *Props) Declare(declare string) *Props {
	js.Rewrite("$_.Set('declare', $1)", declare)
	p.attrs["declare"] = declare
	return p
}
...
// Hspace fn
func Hspace(hspace string) *Props {
	js.Rewrite("$1().Set('hspace', $2)", js.Runtime("Map", "Set", "JSON"), hspace)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Hspace(hspace)
}

// Hspace fn
func (p *Props) Hspace(hspace string) *Props {
	js.Rewrite("$_.Set('hspace', $1)", hspace)
	p.attrs["hspace"] = hspace
	return p
}
...
// Standby fn
func Standby(standby string) *Props {
	js.Rewrite("$1().Set('standby', $2)", js.Runtime("Map", "Set", "JSON"), standby)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Standby(standby)
}

// Standby fn
func (p *Props) Standby(standby string) *Props {
	js.Rewrite("$_.Set('standby', $1)", standby)
	p.attrs["standby"] = standby
	return p
}
...
// Typemustmatch fn
func Typemustmatch(typemustmatch string) *Props {
	js.Rewrite("$1().Set('typemustmatch', $2)", js.Runtime("Map", "Set", "JSON"), typemustmatch)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Typemustmatch(typemustmatch)
}

// Typemustmatch fn
func (p *Props) Typemustmatch(typemustmatch string) *Props {
	js.Rewrite("$_.Set('typemustmatch', $1)", typemustmatch)
	p.attrs["typemustmatch"] = typemustmatch
	return p
}
...
// Vspace fn
func Vspace(vspace string) *Props {
	js.Rewrite("$1().Set('vspace', $2)", js.Runtime("Map", "Set", "JSON"), vspace)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Vspace(vspace)
}

// Vspace fn
func (p *Props) Vspace(vspace string) *Props {
	js.Rewrite("$_.Set('vspace', $1)", vspace)
	p.attrs["vspace"] = vspace
	return p
}
