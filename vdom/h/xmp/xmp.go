...
// New fn
func New(props *Props, children ...vdom.Child) *Xmp {
	js.Rewrite("$1('xmp', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Xmp) Render() vdom.Node {
	return s
}

func (s *Xmp) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<xmp " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</xmp>"
	}

	return "<xmp>" + strings.Join(children, "") + "</xmp>"
}
