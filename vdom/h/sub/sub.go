...
// New fn
func New(props *Props, children ...vdom.Child) *Sub {
	js.Rewrite("$1('sub', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Sub) String() string {
	...
	if len(props) > 0 {
		return "<sub " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</sub>"
	}

	return "<sub>" + strings.Join(children, "") + "</sub>"
}
