...
// New fn
func New(props *Props, children ...vdom.Child) *Canvas {
	js.Rewrite("$1('canvas', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Canvas) Render() vdom.Node {
	return s
}
...
func (s *Canvas) String() string {
	...
	if len(props) > 0 {
		return "<canvas " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</canvas>"
	}

	return "<canvas>" + strings.Join(children, "") + "</canvas>"
}
