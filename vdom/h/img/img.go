...
func New(props *Props, children ...vdom.Child) *Img {
	macro.Rewrite("$1('img', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Alt(alt string) *Props {
	macro.Rewrite("$1().Set('alt', $2)", js.Runtime("Map", "Set", "JSON"), alt)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Alt(alt)
}
...
func Crossorigin(crossorigin string) *Props {
	macro.Rewrite("$1().Set('crossorigin', $2)", js.Runtime("Map", "Set", "JSON"), crossorigin)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Crossorigin(crossorigin string) *Props {
	macro.Rewrite("$_.Set('crossorigin', $1)", crossorigin)
...
func Ismap(ismap string) *Props {
	macro.Rewrite("$1().Set('ismap', $2)", js.Runtime("Map", "Set", "JSON"), ismap)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Ismap(ismap string) *Props {
	macro.Rewrite("$_.Set('ismap', $1)", ismap)
	p.attrs["ismap"] = ismap
	return p
}
...
func Sizes(sizes string) *Props {
	macro.Rewrite("$1().Set('sizes', $2)", js.Runtime("Map", "Set", "JSON"), sizes)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Sizes(sizes string) *Props {
	macro.Rewrite("$_.Set('sizes', $1)", sizes)
	p.attrs["sizes"] = sizes
	return p
}
...
func Srcset(srcset string) *Props {
	macro.Rewrite("$1().Set('srcset', $2)", js.Runtime("Map", "Set", "JSON"), srcset)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Srcset(srcset string) *Props {
	macro.Rewrite("$_.Set('srcset', $1)", srcset)
