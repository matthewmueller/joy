...
// New fn
func New(props *Props, children ...vdom.Child) *Img {
	js.Rewrite("$1('img', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Img) String() string {
	...
	if len(props) > 0 {
		return "<img " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</img>"
	}

	return "<img>" + strings.Join(children, "") + "</img>"
}
...
// Crossorigin fn
func Crossorigin(crossorigin string) *Props {
	js.Rewrite("$1().Set('crossorigin', $2)", js.Runtime("Map", "Set", "JSON"), crossorigin)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Crossorigin(crossorigin)
}

// Crossorigin fn
func (p *Props) Crossorigin(crossorigin string) *Props {
	js.Rewrite("$_.Set('crossorigin', $1)", crossorigin)
	p.attrs["crossorigin"] = crossorigin
	return p
}
...
// Sizes fn
func Sizes(sizes string) *Props {
	js.Rewrite("$1().Set('sizes', $2)", js.Runtime("Map", "Set", "JSON"), sizes)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Sizes(sizes)
}

// Sizes fn
func (p *Props) Sizes(sizes string) *Props {
	js.Rewrite("$_.Set('sizes', $1)", sizes)
	p.attrs["sizes"] = sizes
	return p
}
...
// Srcset fn
func Srcset(srcset string) *Props {
	js.Rewrite("$1().Set('srcset', $2)", js.Runtime("Map", "Set", "JSON"), srcset)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Srcset(srcset)
}

// Srcset fn
func (p *Props) Srcset(srcset string) *Props {
	js.Rewrite("$_.Set('srcset', $1)", srcset)
	p.attrs["srcset"] = srcset
	return p
}
