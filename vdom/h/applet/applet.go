...
// New fn
func New(props *Props, children ...vdom.Child) *Applet {
	js.Rewrite("$1('applet', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Applet) Render() vdom.Node {
	return s
}

func (s *Applet) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<applet " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</applet>"
	}

	return "<applet>" + strings.Join(children, "") + "</applet>"
}
...
// Code fn
func Code(code string) *Props {
	js.Rewrite("$1().Set('code', $2)", js.Runtime("Map", "Set", "JSON"), code)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Code(code)
}

// Code fn
func (p *Props) Code(code string) *Props {
	js.Rewrite("$_.Set('code', $1)", code)
	p.attrs["code"] = code
	return p
}
...
// Object fn
func Object(object string) *Props {
	js.Rewrite("$1().Set('object', $2)", js.Runtime("Map", "Set", "JSON"), object)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Object(object)
}

// Object fn
func (p *Props) Object(object string) *Props {
	js.Rewrite("$_.Set('object', $1)", object)
	p.attrs["object"] = object
	return p
}
