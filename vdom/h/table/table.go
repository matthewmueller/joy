...
// New fn
func New(props *Props, children ...vdom.Child) *Table {
	js.Rewrite("$1('table', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Table) String() string {
	...
	if len(props) > 0 {
		return "<table " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</table>"
	}

	return "<table>" + strings.Join(children, "") + "</table>"
}
...
// Cellpadding fn
func Cellpadding(cellpadding string) *Props {
	js.Rewrite("$1().Set('cellpadding', $2)", js.Runtime("Map", "Set", "JSON"), cellpadding)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Cellpadding(cellpadding)
}

// Cellpadding fn
func (p *Props) Cellpadding(cellpadding string) *Props {
	js.Rewrite("$_.Set('cellpadding', $1)", cellpadding)
	p.attrs["cellpadding"] = cellpadding
	return p
}

// Cellspacing fn
func Cellspacing(cellspacing string) *Props {
	js.Rewrite("$1().Set('cellspacing', $2)", js.Runtime("Map", "Set", "JSON"), cellspacing)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Cellspacing(cellspacing)
}

// Cellspacing fn
func (p *Props) Cellspacing(cellspacing string) *Props {
	js.Rewrite("$_.Set('cellspacing', $1)", cellspacing)
	p.attrs["cellspacing"] = cellspacing
	return p
}

// Frame fn
func Frame(frame string) *Props {
	js.Rewrite("$1().Set('frame', $2)", js.Runtime("Map", "Set", "JSON"), frame)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Frame(frame)
}

// Frame fn
func (p *Props) Frame(frame string) *Props {
	js.Rewrite("$_.Set('frame', $1)", frame)
	p.attrs["frame"] = frame
	return p
}

// Rules fn
func Rules(rules string) *Props {
	js.Rewrite("$1().Set('rules', $2)", js.Runtime("Map", "Set", "JSON"), rules)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Rules(rules)
}

// Rules fn
func (p *Props) Rules(rules string) *Props {
	js.Rewrite("$_.Set('rules', $1)", rules)
	p.attrs["rules"] = rules
	return p
}

// Summary fn
func Summary(summary string) *Props {
	js.Rewrite("$1().Set('summary', $2)", js.Runtime("Map", "Set", "JSON"), summary)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Summary(summary)
}

// Summary fn
func (p *Props) Summary(summary string) *Props {
	js.Rewrite("$_.Set('summary', $1)", summary)
	p.attrs["summary"] = summary
	return p
}
