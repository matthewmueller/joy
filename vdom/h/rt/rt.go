...
// New fn
func New(props *Props, children ...vdom.Child) *Rt {
	js.Rewrite("$1('rt', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Rt) String() string {
	...
	if len(props) > 0 {
		return "<rt " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</rt>"
	}

	return "<rt>" + strings.Join(children, "") + "</rt>"
}
