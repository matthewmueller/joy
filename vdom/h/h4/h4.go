...
// New fn
func New(props *Props, children ...vdom.Child) *H4 {
	js.Rewrite("$1('h4', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *H4) Render() vdom.Node {
	return s
}

func (s *H4) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<h4 " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</h4>"
	}

	return "<h4>" + strings.Join(children, "") + "</h4>"
}
