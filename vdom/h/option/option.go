...
func New(props *Props, children ...vdom.Child) *Option {
	js.Rewrite("$1('option', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Selected(selected string) *Props {
	js.Rewrite("$1().Set('selected', $2)", js.Runtime("Map", "Set", "JSON"), selected)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Selected(selected string) *Props {
	js.Rewrite("$_.Set('selected', $1)", selected)
