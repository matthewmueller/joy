...
// New fn
func New(props *Props, children ...vdom.Child) *H5 {
	js.Rewrite("$1('h5', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *H5) Render() vdom.Node {
	return s
}

func (s *H5) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<h5 " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</h5>"
	}

	return "<h5>" + strings.Join(children, "") + "</h5>"
}
