...
// New fn
func New(props *Props, children ...vdom.Child) *Body {
	js.Rewrite("$1('body', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Body) String() string {
	...
	if len(props) > 0 {
		return "<body " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</body>"
	}

	return "<body>" + strings.Join(children, "") + "</body>"
}
...
// Alink fn
func Alink(alink string) *Props {
	js.Rewrite("$1().Set('alink', $2)", js.Runtime("Map", "Set", "JSON"), alink)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Alink(alink)
}

// Alink fn
func (p *Props) Alink(alink string) *Props {
	js.Rewrite("$_.Set('alink', $1)", alink)
	p.attrs["alink"] = alink
	return p
}

// Background fn
func Background(background string) *Props {
	js.Rewrite("$1().Set('background', $2)", js.Runtime("Map", "Set", "JSON"), background)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Background(background)
}

// Background fn
func (p *Props) Background(background string) *Props {
	js.Rewrite("$_.Set('background', $1)", background)
	p.attrs["background"] = background
	return p
}
...
// Link fn
func Link(link string) *Props {
	js.Rewrite("$1().Set('link', $2)", js.Runtime("Map", "Set", "JSON"), link)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Link(link)
}

// Link fn
func (p *Props) Link(link string) *Props {
	js.Rewrite("$_.Set('link', $1)", link)
	p.attrs["link"] = link
	return p
}
...
func Text(text string) *Props {
	js.Rewrite("$1().Set('text', $2)", js.Runtime("Map", "Set", "JSON"), text)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Text(text)
}
...
func (p *Props) Text(text string) *Props {
	js.Rewrite("$_.Set('text', $1)", text)
	p.attrs["text"] = text
	return p
}

// Vlink fn
func Vlink(vlink string) *Props {
	js.Rewrite("$1().Set('vlink', $2)", js.Runtime("Map", "Set", "JSON"), vlink)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Vlink(vlink)
}

// Vlink fn
func (p *Props) Vlink(vlink string) *Props {
	js.Rewrite("$_.Set('vlink', $1)", vlink)
	p.attrs["vlink"] = vlink
	return p
}
