...
func Alink(alink string) *Props {
	macro.Rewrite("$1().Set('alink', $2)", js.Runtime("Map", "Set", "JSON"), alink)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Alink(alink string) *Props {
	macro.Rewrite("$_.Set('alink', $1)", alink)
	p.attrs["alink"] = alink
	return p
}
...
func Background(background string) *Props {
	macro.Rewrite("$1().Set('background', $2)", js.Runtime("Map", "Set", "JSON"), background)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Background(background string) *Props {
	macro.Rewrite("$_.Set('background', $1)", background)
...
func Link(link string) *Props {
	macro.Rewrite("$1().Set('link', $2)", js.Runtime("Map", "Set", "JSON"), link)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Link(link)
}
...
func (p *Props) Link(link string) *Props {
	macro.Rewrite("$_.Set('link', $1)", link)
	p.attrs["link"] = link
	return p
}
...
func Text(text string) *Props {
	macro.Rewrite("$1().Set('text', $2)", js.Runtime("Map", "Set", "JSON"), text)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Text(text)
}
...
func (p *Props) Text(text string) *Props {
	macro.Rewrite("$_.Set('text', $1)", text)
	p.attrs["text"] = text
	return p
}
...
func Vlink(vlink string) *Props {
	macro.Rewrite("$1().Set('vlink', $2)", js.Runtime("Map", "Set", "JSON"), vlink)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Vlink(vlink string) *Props {
	macro.Rewrite("$_.Set('vlink', $1)", vlink)
	p.attrs["vlink"] = vlink
	return p
}
