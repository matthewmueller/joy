...
// New fn
func New(props *Props, children ...vdom.Child) *Multicol {
	js.Rewrite("$1('multicol', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Multicol) Render() vdom.Node {
	return s
}

func (s *Multicol) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<multicol " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</multicol>"
	}

	return "<multicol>" + strings.Join(children, "") + "</multicol>"
}
