...
// New fn
func New(props *Props, children ...vdom.Child) *Dl {
	js.Rewrite("$1('dl', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Dl) Render() vdom.Node {
	return s
}

func (s *Dl) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<dl " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</dl>"
	}

	return "<dl>" + strings.Join(children, "") + "</dl>"
}
