...
// New fn
func New(props *Props, children ...vdom.Child) *Nextid {
	js.Rewrite("$1('nextid', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Nextid) Render() vdom.Node {
	return s
}

func (s *Nextid) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<nextid " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</nextid>"
	}

	return "<nextid>" + strings.Join(children, "") + "</nextid>"
}
