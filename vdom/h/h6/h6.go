...
// New fn
func New(props *Props, children ...vdom.Child) *H6 {
	js.Rewrite("$1('h6', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *H6) Render() vdom.Node {
	return s
}

func (s *H6) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<h6 " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</h6>"
	}

	return "<h6>" + strings.Join(children, "") + "</h6>"
}
