...
// New fn
func New(props *Props, children ...vdom.Child) *Base {
	js.Rewrite("$1('base', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Base) String() string {
	...
	if len(props) > 0 {
		return "<base " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</base>"
	}

	return "<base>" + strings.Join(children, "") + "</base>"
}
