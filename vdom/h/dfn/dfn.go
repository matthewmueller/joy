...
// New fn
func New(props *Props, children ...vdom.Child) *Dfn {
	js.Rewrite("$1('dfn', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Dfn) Render() vdom.Node {
	return s
}

func (s *Dfn) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<dfn " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</dfn>"
	}

	return "<dfn>" + strings.Join(children, "") + "</dfn>"
}
