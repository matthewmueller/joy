...
// New fn
func New(props *Props, children ...vdom.Child) *Col {
	js.Rewrite("$1('col', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Col) String() string {
	...
	if len(props) > 0 {
		return "<col " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</col>"
	}

	return "<col>" + strings.Join(children, "") + "</col>"
}
