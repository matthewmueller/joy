...
// New fn
func New(props *Props, children ...vdom.Child) *Sup {
	js.Rewrite("$1('sup', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Sup) String() string {
	...
	if len(props) > 0 {
		return "<sup " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</sup>"
	}

	return "<sup>" + strings.Join(children, "") + "</sup>"
}
