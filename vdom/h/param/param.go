...
// New fn
func New(props *Props, children ...vdom.Child) *Param {
	js.Rewrite("$1('param', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Param) String() string {
	...
	if len(props) > 0 {
		return "<param " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</param>"
	}

	return "<param>" + strings.Join(children, "") + "</param>"
}
...
// Valuetype fn
func Valuetype(valuetype string) *Props {
	js.Rewrite("$1().Set('valuetype', $2)", js.Runtime("Map", "Set", "JSON"), valuetype)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Valuetype(valuetype)
}

// Valuetype fn
func (p *Props) Valuetype(valuetype string) *Props {
	js.Rewrite("$_.Set('valuetype', $1)", valuetype)
	p.attrs["valuetype"] = valuetype
	return p
}
