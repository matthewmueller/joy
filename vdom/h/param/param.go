...
func New(props *Props, children ...vdom.Child) *Param {
	macro.Rewrite("$1('param', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func Valuetype(valuetype string) *Props {
	macro.Rewrite("$1().Set('valuetype', $2)", js.Runtime("Map", "Set", "JSON"), valuetype)
	p := &Props{attrs: map[string]interface{}{}}
...
func (p *Props) Valuetype(valuetype string) *Props {
	macro.Rewrite("$_.Set('valuetype', $1)", valuetype)
