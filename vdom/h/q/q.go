...
// New fn
func New(props *Props, children ...vdom.Child) *Q {
	js.Rewrite("$1('q', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Q) String() string {
	...
	if len(props) > 0 {
		return "<q " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</q>"
	}

	return "<q>" + strings.Join(children, "") + "</q>"
}
