...
// New fn
func New(props *Props, children ...vdom.Child) *S {
	js.Rewrite("$1('s', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *S) String() string {
	...
	if len(props) > 0 {
		return "<s " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</s>"
	}

	return "<s>" + strings.Join(children, "") + "</s>"
}
