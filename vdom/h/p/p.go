...
// New fn
func New(props *Props, children ...vdom.Child) *P {
	js.Rewrite("$1('p', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *P) String() string {
	...
	if len(props) > 0 {
		return "<p " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</p>"
	}
