...
// New fn
func New(props *Props, children ...vdom.Child) *H2 {
	js.Rewrite("$1('h2', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *H2) Render() vdom.Node {
	return s
}

func (s *H2) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<h2 " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</h2>"
	}

	return "<h2>" + strings.Join(children, "") + "</h2>"
}
