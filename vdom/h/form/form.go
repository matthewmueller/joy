...
// New fn
func New(props *Props, children ...vdom.Child) *Form {
	js.Rewrite("$1('form', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Form) String() string {
	...
	if len(props) > 0 {
		return "<form " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</form>"
	}

	return "<form>" + strings.Join(children, "") + "</form>"
}
...
// AcceptCharset fn
func AcceptCharset(acceptcharset string) *Props {
	js.Rewrite("$1().Set('acceptcharset', $2)", js.Runtime("Map", "Set", "JSON"), acceptcharset)
	p := &Props{attrs: map[string]interface{}{}}
	return p.AcceptCharset(acceptcharset)
}

// AcceptCharset fn
func (p *Props) AcceptCharset(acceptcharset string) *Props {
	js.Rewrite("$_.Set('acceptcharset', $1)", acceptcharset)
	p.attrs["accept-charset"] = acceptcharset
	return p
}

// Action fn
func Action(action string) *Props {
	js.Rewrite("$1().Set('action', $2)", js.Runtime("Map", "Set", "JSON"), action)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Action(action)
}

// Action fn
func (p *Props) Action(action string) *Props {
	js.Rewrite("$_.Set('action', $1)", action)
	p.attrs["action"] = action
	return p
}
...
// Enctype fn
func Enctype(enctype string) *Props {
	js.Rewrite("$1().Set('enctype', $2)", js.Runtime("Map", "Set", "JSON"), enctype)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Enctype(enctype)
}

// Enctype fn
func (p *Props) Enctype(enctype string) *Props {
	js.Rewrite("$_.Set('enctype', $1)", enctype)
	p.attrs["enctype"] = enctype
	return p
}

// Method fn
func Method(method string) *Props {
	js.Rewrite("$1().Set('method', $2)", js.Runtime("Map", "Set", "JSON"), method)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Method(method)
}

// Method fn
func (p *Props) Method(method string) *Props {
	js.Rewrite("$_.Set('method', $1)", method)
	p.attrs["method"] = method
	return p
}
...
// Novalidate fn
func Novalidate(novalidate string) *Props {
	js.Rewrite("$1().Set('novalidate', $2)", js.Runtime("Map", "Set", "JSON"), novalidate)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Novalidate(novalidate)
}

// Novalidate fn
func (p *Props) Novalidate(novalidate string) *Props {
	js.Rewrite("$_.Set('novalidate', $1)", novalidate)
	p.attrs["novalidate"] = novalidate
	return p
}
