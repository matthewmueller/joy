...
// New fn
func New(props *Props, children ...vdom.Child) *Main {
	js.Rewrite("$1('main', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Main) Render() vdom.Node {
	return s
}

func (s *Main) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<main " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</main>"
	}

	return "<main>" + strings.Join(children, "") + "</main>"
}
