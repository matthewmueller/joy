...
// New fn
func New(props *Props, children ...vdom.Child) *Li {
	js.Rewrite("$1('li', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Li) Render() vdom.Node {
	return s
}

func (s *Li) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<li " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</li>"
	}

	return "<li>" + strings.Join(children, "") + "</li>"
}
