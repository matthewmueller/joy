...
// New fn
func New(props *Props, children ...vdom.Child) *Ul {
	js.Rewrite("$1('ul', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Ul) Render() vdom.Node {
	return s
}

func (s *Ul) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<ul " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</ul>"
	}

	return "<ul>" + strings.Join(children, "") + "</ul>"
}
