...
// New fn
func New(props *Props, children ...vdom.Child) *Ins {
	js.Rewrite("$1('ins', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Ins) Render() vdom.Node {
	return s
}

func (s *Ins) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<ins " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</ins>"
	}

	return "<ins>" + strings.Join(children, "") + "</ins>"
}
