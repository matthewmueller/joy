...
// New fn
func New(props *Props, children ...vdom.Child) *Bgsound {
	js.Rewrite("$1('bgsound', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Bgsound) Render() vdom.Node {
	return s
}

func (s *Bgsound) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<bgsound " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</bgsound>"
	}

	return "<bgsound>" + strings.Join(children, "") + "</bgsound>"
}
