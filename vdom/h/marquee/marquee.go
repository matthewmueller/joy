...
// New fn
func New(props *Props, children ...vdom.Child) *Marquee {
	js.Rewrite("$1('marquee', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Marquee) Render() vdom.Node {
	return s
}

func (s *Marquee) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<marquee " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</marquee>"
	}

	return "<marquee>" + strings.Join(children, "") + "</marquee>"
}
