...
// New fn
func New(props *Props, children ...vdom.Child) *Rp {
	js.Rewrite("$1('rp', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Rp) Render() vdom.Node {
	return s
}

func (s *Rp) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<rp " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</rp>"
	}

	return "<rp>" + strings.Join(children, "") + "</rp>"
}
