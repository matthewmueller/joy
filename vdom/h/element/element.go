...
// New fn
func New(props *Props, children ...vdom.Child) *Element {
	js.Rewrite("$1('element', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Element) Render() vdom.Node {
	return s
}
...
func (s *Element) String() string {
	...
	if len(props) > 0 {
		return "<element " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</element>"
	}

	return "<element>" + strings.Join(children, "") + "</element>"
}
