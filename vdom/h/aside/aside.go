...
// New fn
func New(props *Props, children ...vdom.Child) *Aside {
	js.Rewrite("$1('aside', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Aside) Render() vdom.Node {
	return s
}

func (s *Aside) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<aside " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</aside>"
	}

	return "<aside>" + strings.Join(children, "") + "</aside>"
}
