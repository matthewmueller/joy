...
// New fn
func New(props *Props, children ...vdom.Child) *Image {
	js.Rewrite("$1('image', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
func (s *Image) String() string {
	...
	if len(props) > 0 {
		return "<image " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</image>"
	}

	return "<image>" + strings.Join(children, "") + "</image>"
}
