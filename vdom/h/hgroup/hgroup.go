...
// New fn
func New(props *Props, children ...vdom.Child) *Hgroup {
	js.Rewrite("$1('hgroup', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Hgroup) Render() vdom.Node {
	return s
}

func (s *Hgroup) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<hgroup " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</hgroup>"
	}

	return "<hgroup>" + strings.Join(children, "") + "</hgroup>"
}
