...
// New fn
func New(props *Props, children ...vdom.Child) *Dt {
	js.Rewrite("$1('dt', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Render fn
func (s *Dt) Render() vdom.Node {
	return s
}

func (s *Dt) String() string {
	// props
	var props []string
	...
	if len(props) > 0 {
		return "<dt " + strings.Join(props, " ") + ">" + strings.Join(children, "") + "</dt>"
	}

	return "<dt>" + strings.Join(children, "") + "</dt>"
}
