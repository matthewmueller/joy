...
func New(props *Props, children ...vdom.Child) *Body {
	macro.Rewrite("$1('body', $2 ? $2.JSON() : {}, $3)", vdom.Pragma(), props, children)
	if props == nil {
...
// Onafterprint fn
func Onafterprint(onafterprint string) *Props {
	macro.Rewrite("$1().Set('onafterprint', $2)", macro.Runtime("Map", "Set", "JSON"), onafterprint)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Onafterprint(onafterprint)
}

// Onafterprint fn
func (p *Props) Onafterprint(onafterprint string) *Props {
	macro.Rewrite("$_.Set('onafterprint', $1)", onafterprint)
	p.attrs["onafterprint"] = onafterprint
	return p
}

// Onbeforeprint fn
func Onbeforeprint(onbeforeprint string) *Props {
	macro.Rewrite("$1().Set('onbeforeprint', $2)", macro.Runtime("Map", "Set", "JSON"), onbeforeprint)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Onbeforeprint(onbeforeprint)
}

// Onbeforeprint fn
func (p *Props) Onbeforeprint(onbeforeprint string) *Props {
	macro.Rewrite("$_.Set('onbeforeprint', $1)", onbeforeprint)
	p.attrs["onbeforeprint"] = onbeforeprint
	return p
}

// Onbeforeunload fn
func Onbeforeunload(onbeforeunload string) *Props {
	macro.Rewrite("$1().Set('onbeforeunload', $2)", macro.Runtime("Map", "Set", "JSON"), onbeforeunload)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Onbeforeunload(onbeforeunload)
}

// Onbeforeunload fn
func (p *Props) Onbeforeunload(onbeforeunload string) *Props {
	macro.Rewrite("$_.Set('onbeforeunload', $1)", onbeforeunload)
	p.attrs["onbeforeunload"] = onbeforeunload
	return p
}

// Onhashchange fn
func Onhashchange(onhashchange string) *Props {
	macro.Rewrite("$1().Set('onhashchange', $2)", macro.Runtime("Map", "Set", "JSON"), onhashchange)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Onhashchange(onhashchange)
}

// Onhashchange fn
func (p *Props) Onhashchange(onhashchange string) *Props {
	macro.Rewrite("$_.Set('onhashchange', $1)", onhashchange)
	p.attrs["onhashchange"] = onhashchange
	return p
}

// Onlanguagechange fn
func Onlanguagechange(onlanguagechange string) *Props {
	macro.Rewrite("$1().Set('onlanguagechange', $2)", macro.Runtime("Map", "Set", "JSON"), onlanguagechange)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Onlanguagechange(onlanguagechange)
}

// Onlanguagechange fn
func (p *Props) Onlanguagechange(onlanguagechange string) *Props {
	macro.Rewrite("$_.Set('onlanguagechange', $1)", onlanguagechange)
	p.attrs["onlanguagechange"] = onlanguagechange
	return p
}

// Onmessage fn
func Onmessage(onmessage string) *Props {
	macro.Rewrite("$1().Set('onmessage', $2)", macro.Runtime("Map", "Set", "JSON"), onmessage)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Onmessage(onmessage)
}

// Onmessage fn
func (p *Props) Onmessage(onmessage string) *Props {
	macro.Rewrite("$_.Set('onmessage', $1)", onmessage)
	p.attrs["onmessage"] = onmessage
	return p
}

// Onoffline fn
func Onoffline(onoffline string) *Props {
	macro.Rewrite("$1().Set('onoffline', $2)", macro.Runtime("Map", "Set", "JSON"), onoffline)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Onoffline(onoffline)
}

// Onoffline fn
func (p *Props) Onoffline(onoffline string) *Props {
	macro.Rewrite("$_.Set('onoffline', $1)", onoffline)
	p.attrs["onoffline"] = onoffline
	return p
}

// Ononline fn
func Ononline(ononline string) *Props {
	macro.Rewrite("$1().Set('ononline', $2)", macro.Runtime("Map", "Set", "JSON"), ononline)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Ononline(ononline)
}

// Ononline fn
func (p *Props) Ononline(ononline string) *Props {
	macro.Rewrite("$_.Set('ononline', $1)", ononline)
	p.attrs["ononline"] = ononline
	return p
}

// Onpagehide fn
func Onpagehide(onpagehide string) *Props {
	macro.Rewrite("$1().Set('onpagehide', $2)", macro.Runtime("Map", "Set", "JSON"), onpagehide)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Onpagehide(onpagehide)
}

// Onpagehide fn
func (p *Props) Onpagehide(onpagehide string) *Props {
	macro.Rewrite("$_.Set('onpagehide', $1)", onpagehide)
	p.attrs["onpagehide"] = onpagehide
	return p
}

// Onpageshow fn
func Onpageshow(onpageshow string) *Props {
	macro.Rewrite("$1().Set('onpageshow', $2)", macro.Runtime("Map", "Set", "JSON"), onpageshow)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Onpageshow(onpageshow)
}

// Onpageshow fn
func (p *Props) Onpageshow(onpageshow string) *Props {
	macro.Rewrite("$_.Set('onpageshow', $1)", onpageshow)
	p.attrs["onpageshow"] = onpageshow
	return p
}

// Onpopstate fn
func Onpopstate(onpopstate string) *Props {
	macro.Rewrite("$1().Set('onpopstate', $2)", macro.Runtime("Map", "Set", "JSON"), onpopstate)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Onpopstate(onpopstate)
}

// Onpopstate fn
func (p *Props) Onpopstate(onpopstate string) *Props {
	macro.Rewrite("$_.Set('onpopstate', $1)", onpopstate)
	p.attrs["onpopstate"] = onpopstate
	return p
}

// Onstorage fn
func Onstorage(onstorage string) *Props {
	macro.Rewrite("$1().Set('onstorage', $2)", macro.Runtime("Map", "Set", "JSON"), onstorage)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Onstorage(onstorage)
}

// Onstorage fn
func (p *Props) Onstorage(onstorage string) *Props {
	macro.Rewrite("$_.Set('onstorage', $1)", onstorage)
	p.attrs["onstorage"] = onstorage
	return p
}

// Onunload fn
func Onunload(onunload string) *Props {
	macro.Rewrite("$1().Set('onunload', $2)", macro.Runtime("Map", "Set", "JSON"), onunload)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Onunload(onunload)
}

// Onunload fn
func (p *Props) Onunload(onunload string) *Props {
	macro.Rewrite("$_.Set('onunload', $1)", onunload)
	p.attrs["onunload"] = onunload
	return p
}
