...
func Low(low string) *Props {
	macro.Rewrite("$1().Set('low', $2)", macro.Runtime("Map", "Set", "JSON"), low)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Low(low)
}
...
func High(high string) *Props {
	macro.Rewrite("$1().Set('high', $2)", macro.Runtime("Map", "Set", "JSON"), high)
	p := &Props{attrs: map[string]interface{}{}}
	return p.High(high)
}
...
func Optimum(optimum string) *Props {
	macro.Rewrite("$1().Set('optimum', $2)", macro.Runtime("Map", "Set", "JSON"), optimum)
	p := &Props{attrs: map[string]interface{}{}}
