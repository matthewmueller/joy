...
func Crossorigin(crossorigin string) *Props {
	macro.Rewrite("$1().Set('crossorigin', $2)", macro.Runtime("Map", "Set", "JSON"), crossorigin)
	p := &Props{attrs: map[string]interface{}{}}
...
func Poster(poster string) *Props {
	macro.Rewrite("$1().Set('poster', $2)", macro.Runtime("Map", "Set", "JSON"), poster)
	p := &Props{attrs: map[string]interface{}{}}
...
func Preload(preload string) *Props {
	macro.Rewrite("$1().Set('preload', $2)", macro.Runtime("Map", "Set", "JSON"), preload)
	p := &Props{attrs: map[string]interface{}{}}
...
func Autoplay(autoplay string) *Props {
	macro.Rewrite("$1().Set('autoplay', $2)", macro.Runtime("Map", "Set", "JSON"), autoplay)
	p := &Props{attrs: map[string]interface{}{}}
...
func Mediagroup(mediagroup string) *Props {
	macro.Rewrite("$1().Set('mediagroup', $2)", macro.Runtime("Map", "Set", "JSON"), mediagroup)
	p := &Props{attrs: map[string]interface{}{}}
...
func Loop(loop string) *Props {
	macro.Rewrite("$1().Set('loop', $2)", macro.Runtime("Map", "Set", "JSON"), loop)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Loop(loop)
}
...
func Muted(muted string) *Props {
	macro.Rewrite("$1().Set('muted', $2)", macro.Runtime("Map", "Set", "JSON"), muted)
	p := &Props{attrs: map[string]interface{}{}}
...
func Controls(controls string) *Props {
	macro.Rewrite("$1().Set('controls', $2)", macro.Runtime("Map", "Set", "JSON"), controls)
	p := &Props{attrs: map[string]interface{}{}}
