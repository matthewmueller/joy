...
func Coords(coords string) *Props {
	macro.Rewrite("$1().Set('coords', $2)", macro.Runtime("Map", "Set", "JSON"), coords)
	p := &Props{attrs: map[string]interface{}{}}
...
func Shape(shape string) *Props {
	macro.Rewrite("$1().Set('shape', $2)", macro.Runtime("Map", "Set", "JSON"), shape)
	p := &Props{attrs: map[string]interface{}{}}
...
func Href(href string) *Props {
	macro.Rewrite("$1().Set('href', $2)", macro.Runtime("Map", "Set", "JSON"), href)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Href(href)
}
...
func Target(target string) *Props {
	macro.Rewrite("$1().Set('target', $2)", macro.Runtime("Map", "Set", "JSON"), target)
	p := &Props{attrs: map[string]interface{}{}}
...
func Download(download string) *Props {
	macro.Rewrite("$1().Set('download', $2)", macro.Runtime("Map", "Set", "JSON"), download)
	p := &Props{attrs: map[string]interface{}{}}
...
func Ping(ping string) *Props {
	macro.Rewrite("$1().Set('ping', $2)", macro.Runtime("Map", "Set", "JSON"), ping)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Ping(ping)
}
...
func Rel(rel string) *Props {
	macro.Rewrite("$1().Set('rel', $2)", macro.Runtime("Map", "Set", "JSON"), rel)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Rel(rel)
}
...
func Hreflang(hreflang string) *Props {
	macro.Rewrite("$1().Set('hreflang', $2)", macro.Runtime("Map", "Set", "JSON"), hreflang)
	p := &Props{attrs: map[string]interface{}{}}
...
func Type(kind string) *Props {
	macro.Rewrite("$1().Set('kind', $2)", macro.Runtime("Map", "Set", "JSON"), kind)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Type(kind)
}
