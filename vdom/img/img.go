...
func Srcset(srcset string) *Props {
	macro.Rewrite("$1().Set('srcset', $2)", macro.Runtime("Map", "Set", "JSON"), srcset)
	p := &Props{attrs: map[string]interface{}{}}
...
func Usemap(usemap string) *Props {
	macro.Rewrite("$1().Set('usemap', $2)", macro.Runtime("Map", "Set", "JSON"), usemap)
	p := &Props{attrs: map[string]interface{}{}}
...
func Ismap(ismap string) *Props {
	macro.Rewrite("$1().Set('ismap', $2)", macro.Runtime("Map", "Set", "JSON"), ismap)
	p := &Props{attrs: map[string]interface{}{}}
