...
func Colspan(colspan string) *Props {
	macro.Rewrite("$1().Set('colspan', $2)", macro.Runtime("Map", "Set", "JSON"), colspan)
...
func Rowspan(rowspan string) *Props {
	macro.Rewrite("$1().Set('rowspan', $2)", macro.Runtime("Map", "Set", "JSON"), rowspan)
	p := &Props{attrs: map[string]interface{}{}}
...
func Headers(headers string) *Props {
	macro.Rewrite("$1().Set('headers', $2)", macro.Runtime("Map", "Set", "JSON"), headers)
	p := &Props{attrs: map[string]interface{}{}}
...
func Scope(scope string) *Props {
	macro.Rewrite("$1().Set('scope', $2)", macro.Runtime("Map", "Set", "JSON"), scope)
	p := &Props{attrs: map[string]interface{}{}}
...
// Sorted fn
func Sorted(sorted string) *Props {
	macro.Rewrite("$1().Set('sorted', $2)", macro.Runtime("Map", "Set", "JSON"), sorted)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Sorted(sorted)
}

// Sorted fn
func (p *Props) Sorted(sorted string) *Props {
	macro.Rewrite("$_.Set('sorted', $1)", sorted)
	p.attrs["sorted"] = sorted
	return p
}

// Abbr fn
func Abbr(abbr string) *Props {
	macro.Rewrite("$1().Set('abbr', $2)", macro.Runtime("Map", "Set", "JSON"), abbr)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Abbr(abbr)
}
