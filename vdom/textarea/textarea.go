...
func Cols(cols string) *Props {
	macro.Rewrite("$1().Set('cols', $2)", macro.Runtime("Map", "Set", "JSON"), cols)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Cols(cols)
}
...
func Rows(rows string) *Props {
	macro.Rewrite("$1().Set('rows', $2)", macro.Runtime("Map", "Set", "JSON"), rows)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Rows(rows)
}
...
func Wrap(wrap string) *Props {
	macro.Rewrite("$1().Set('wrap', $2)", macro.Runtime("Map", "Set", "JSON"), wrap)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Wrap(wrap)
}
