...
func Srcdoc(srcdoc string) *Props {
	macro.Rewrite("$1().Set('srcdoc', $2)", macro.Runtime("Map", "Set", "JSON"), srcdoc)
	p := &Props{attrs: map[string]interface{}{}}
...
func Sandbox(sandbox string) *Props {
	macro.Rewrite("$1().Set('sandbox', $2)", macro.Runtime("Map", "Set", "JSON"), sandbox)
	p := &Props{attrs: map[string]interface{}{}}
...
// Seamless fn
func Seamless(seamless string) *Props {
	macro.Rewrite("$1().Set('seamless', $2)", macro.Runtime("Map", "Set", "JSON"), seamless)
	p := &Props{attrs: map[string]interface{}{}}
	return p.Seamless(seamless)
}

// Seamless fn
func (p *Props) Seamless(seamless string) *Props {
	macro.Rewrite("$_.Set('seamless', $1)", seamless)
	p.attrs["seamless"] = seamless
	return p
}

// Allowfullscreen fn
func Allowfullscreen(allowfullscreen string) *Props {
	macro.Rewrite("$1().Set('allowfullscreen', $2)", macro.Runtime("Map", "Set", "JSON"), allowfullscreen)
	p := &Props{attrs: map[string]interface{}{}}
