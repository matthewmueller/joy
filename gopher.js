...
$packages["main"] = (function() {
	var $pkg = {}, $init, String, S, main;
	String = $pkg.String = $newType(8, $kindString, "main.String", true, "main", true, null);
	String.prototype.concat = function(s2) {
		var s, s2;
		s = this.$val;
		return s + (s2);
	};
	$ptrType(String).prototype.concat = function(s2) { return new String(this.$get()).concat(s2); };
	S = function(s) {
		var s;
		return s;
	};
	$pkg.S = S;
	main = function() {
		console.log(new String("hi").concat("cool"));
		console.log("\x04");
		console.log("\x04");
		console.log(S("hi"));
	};
	String.methods = [{prop: "concat", name: "concat", pkg: "main", typ: $funcType([$String], [String], false)}];
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		if ($pkg === $mainPkg) {
